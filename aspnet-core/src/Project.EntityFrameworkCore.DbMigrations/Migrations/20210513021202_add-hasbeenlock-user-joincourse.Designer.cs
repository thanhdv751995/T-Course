...
namespace Project.Migrations
{
    ...
    [Migration("20210513021202_add-hasbeenlock-user-joincourse")]
    partial class addhasbeenlockuserjoincourse
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Project.BaiHocs.Lesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.Contacts.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.DanhGias.Rate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.DanhMucs.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.KhoaHocs.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProjectCourses");
                });

            modelBuilder.Entity("Project.ThamGiaKhoaHocs.JoinCourse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project.BaiHocs.Lesson", b =>
                {
                    b.HasOne("Project.KhoaHocs.Course", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Project.Comments.Comment", b =>
                {
                    b.HasOne("Project.BaiHocs.Lesson", null)
                        .WithMany()
                        .HasForeignKey("IDLesson")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project.Comments.Comment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Project.DanhMucs.Category", b =>
                {
                    b.HasOne("Project.DanhMucs.Category", null)
                        .WithMany()
                        .HasForeignKey("IDParent")
                        .OnDelete(DeleteBehavior.NoAction);
                });
