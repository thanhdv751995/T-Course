        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectCategories_ProjectCategories_IDParent",
                        column: x => x.IDParent,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DescriptionPrimary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DescriptionSub = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmailPrimary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmailSub = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhonePrimary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneSub = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AddressPrimary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AddressSub = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectCourses_AbpUsers_IDUser",
                        column: x => x.IDUser,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectCourses_ProjectCategories_IDCategory",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectJoinCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectJoinCourses_AbpUsers_IDUser",
                        column: x => x.IDUser,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectJoinCourses_ProjectCourses_IDCourse",
                        column: x => x.IDCourse,
                        principalTable: "ProjectCourses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectLessons_ProjectCourses_IDCourse",
                        column: x => x.IDCourse,
                        principalTable: "ProjectCourses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RatePoint = table.Column<int>(type: "int", maxLength: 6, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectRates_AbpUsers_IDUser",
                        column: x => x.IDUser,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectRates_ProjectCourses_IDCourse",
                        column: x => x.IDCourse,
                        principalTable: "ProjectCourses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectComments_AbpUsers_IDUser",
                        column: x => x.IDUser,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectComments_ProjectLessons_IDLesson",
                        column: x => x.IDLesson,
                        principalTable: "ProjectLessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectCategories_IDParent",
                table: "ProjectCategories",
                column: "IDParent");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectComments_IDLesson",
                table: "ProjectComments",
                column: "IDLesson");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectComments_IDParent",
                table: "ProjectComments",
                column: "IDParent");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectCourses_IDCategory",
                table: "ProjectCourses",
                column: "IDCategory");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectCourses_IDUser",
                table: "ProjectCourses",
                column: "IDUser");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectJoinCourses_IDCourse",
                table: "ProjectJoinCourses",
                column: "IDCourse");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectJoinCourses_IDUser",
                table: "ProjectJoinCourses",
                column: "IDUser");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectLessons_IDCourse",
                table: "ProjectLessons",
                column: "IDCourse");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectRates_IDCourse",
                table: "ProjectRates",
                column: "IDCourse");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectRates_IDUser",
                table: "ProjectRates",
                column: "IDUser");
        }
